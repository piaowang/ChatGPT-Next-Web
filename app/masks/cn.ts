    ...
    context: [
      {
        ...
        role: "user",
        content:
          "我现在需要做一些数据库建模，需要中文名称翻译成英文，请假设你是一个翻译专家和数据库建模专家， 帮我翻译一下， 要求翻译的结果只能返回一个字段，关键单词用英文下划线隔开，通俗、常见的英文世界的的单词可以用缩写，比如数值要用qty结尾，金额要用money结尾，编码要用code结尾，名称要用name结尾，但是不能超过30个字符长度，全部都用大写。",
        date: "",
      },
    ],
    modelConfig: {
